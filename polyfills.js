(self["webpackChunkQAWorkbook"] = self["webpackChunkQAWorkbook"] || []).push([["polyfills"],{
      ...
      if (isFunction(args[0])) {
        ...
        args[0] = function timer() {
          try {
            ...
            var _handle = options.handle,
              _handleId = options.handleId,
              _isPeriodic = options.isPeriodic,
              _isRefreshable = options.isRefreshable;
