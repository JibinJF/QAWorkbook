...
const routes: Routes = [
  ...
  { path: 'PoliticalScienceQA/InternationalInstitutionsQA', component: InternationalInstitutionsQAComponent },
  { path: 'PoliticalScienceQA/InternationalAgreementsQA', component: InternationalAgreementsQAComponent },
