...
@Component({
  ...
  template: `<app-display-qa [qas]="internationalInstitutionsAndAgenciesQAs" [workbookName]="workbookName"></app-display-qa>`,
  styles: [
  ]
})
export class InternationalInstitutionsAndAgenciesQAComponent implements OnInit {
  ...
  internationalInstitutionsAndAgenciesQAs: QAModel[] = [
    {
